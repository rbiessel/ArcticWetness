...
The effects of a changing climate are evident across the globe. In particular though, the Arctic is seeing a vast and fast rise in temperature upwards of 3°C since the industrial revolution, according to the Intergovernmental Panel on Climate Change's 2018 special report [1]. The implications for such a drastic warming shift in the arctic are obvious at first glance. Permafrost (ground that stays below freezing for at least two years) degradation is clearly visible in the form of vast reaches of polygonal terrain in the far north.
